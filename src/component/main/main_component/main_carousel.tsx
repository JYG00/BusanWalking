...
import React, { Component, MouseEvent, ReactNode, useEffect, useRef, useState } from 'react';
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.main_top}>
        ...
        >
          <SlideImg color="red" description="부산 중구 보수동에 위치한..." place="용두산공원" traffic="" mainImg="" title="용처럼 솟아오른 탑" />
        </div>
        <div
          ref={(elem: HTMLDivElement) => {
            if (SlideRef.current !== null) {
        ...
        >
          <SlideImg color="green" description="설명..." place="닥밭골 행복마을" traffic="" mainImg="" title="도심속 작은마을" />
        </div>
        <div
          ref={(elem: HTMLDivElement) => {
            if (SlideRef.current !== null) {
        ...
        >
          <SlideImg color="yellow" description="부산 중구 자갈치에 위치한..." place="자갈치 시장" traffic="" mainImg="" title="수산물과 함께하는 거리" />
        </div>
        <div
          ref={(elem: HTMLDivElement) => {
            if (SlideRef.current !== null) {
        ...
        >
          <SlideImg color="purple" description="광안리를 따라 해안길을..." place="광안리 산책코스 A-C" traffic="" mainImg="" title="바다의 향기를 담아" />
        </div>
        <div
          ref={(elem: HTMLDivElement) => {
            if (SlideRef.current !== null) {
        ...
        >
          <SlideImg color="orange" description="부산 사하구 감천동에 위치한 이 마을은 ..." place="감천문화마을" traffic="" mainImg="" title="아늑한 달동네" />
        </div>
        <div
          ref={(elem: HTMLDivElement) => {
            if (SlideRef.current !== null) {
...
function SlideImg(props: SlideProps) {
  ...
  return (
    <div className={styles.slide} style={{ backgroundColor: props.color }}>
      <div>
